...
PAIRS=(
  ...
  "backend/renew.py|/opt/certinel/renew.py"
  "backend/acme_client.py|/opt/certinel/acme_client.py"
  "backend/acme_dns.py|/opt/certinel/acme_dns.py"
  "backend/ca_providers.py|/opt/certinel/ca_providers.py"
  "backend/acme_server.py|/opt/certinel/acme_server.py"
  "backend/routes_acme.py|/opt/certinel/routes_acme.py"
  "backend/routes_deliver.py|/opt/certinel/routes_deliver.py"
  ...
  "frontend/index.html|/var/www/certinel/index.html"
  "frontend/app.css|/var/www/certinel/app.css"
  "frontend/app.1-core.js|/var/www/certinel/app.1-core.js"
  "frontend/app.2-jobs.js|/var/www/certinel/app.2-jobs.js"
  "frontend/app.3-admin.js|/var/www/certinel/app.3-admin.js"
  "frontend/app.4-misc-boot.js|/var/www/certinel/app.4-misc-boot.js"
  "frontend/app.5-guide.js|/var/www/certinel/app.5-guide.js"
